...
public class DozerAdapterTest {
	...
	public void parseEntityToVOTest() {
		PessoaVO output = DozerAdapter.parseObject(mockEntity(0), PessoaVO.class);
		...
		Assert.assertEquals("email0", output.getEmail());
	}

	@Test
	public void parseEntityListToVOListTest() {
		List<PessoaVO> outputList = DozerAdapter.parseListObjects(mockEntityList(), PessoaVO.class);
		...
		Assert.assertEquals("email0", outputZero.getEmail());
	}
